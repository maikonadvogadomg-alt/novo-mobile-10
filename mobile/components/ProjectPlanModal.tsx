...
export default function ProjectPlanModal({
  ...
  const TABS = [
    { key: "overview", label: "VisÃÂ£o Geral", icon: "bar-chart-2" },
    { key: "tree", label: "ÃÂrvore", icon: "git-branch" },
    { key: "routes", label: "Rotas", icon: "globe" },
    { key: "suggestions", label: "SugestÃÂµes", icon: "zap" },
  ] as const;
              ...
              {plan.apiRoutes.length === 0 ? (
                <View style={styles.emptyState}>
                  ...
                  <Text style={[styles.emptyHint, { color: colors.mutedForeground }]}>
                    Rotas express, fetch e decorators sÃÂ£o detectados automaticamente
                  </Text>
                </View>
              ) : (
