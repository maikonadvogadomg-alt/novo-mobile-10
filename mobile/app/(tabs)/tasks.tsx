...
const STATUS_CONFIG: Record<Status, { label: string; color: string; icon: string }> = {
  ...
  concluido: { label: "ConcluÃÂ­do", color: "#10b981", icon: "check-circle" },
};

const PRIORITY_CONFIG: Record<Priority, { label: string; color: string }> = {
  alta: { label: "Alta", color: "#ef4444" },
  media: { label: "MÃÂ©dia", color: "#f59e0b" },
          ...
          <View style={styles.cardFooter}>
            ...
            {task.completedAt && (
              <Text style={[styles.cardDate, { color: colors.mutedForeground }]}>
                Ã¢ÂÂ {new Date(task.completedAt).toLocaleDateString("pt-BR")}
              </Text>
            )}
          </View>
        </View>
          ...
          {tasks.length > 0 && (
            <View style={[styles.hintBar, { backgroundColor: "#00d4aa12", borderBottomColor: "#00d4aa33" }]}>
              ...
              <Text style={[styles.hintText, { color: "#00d4aa" }]}>
                A IA conhece suas {tasks.length} tarefas e nÃÂ£o vai quebrar o que jÃÂ¡ foi concluÃÂ­do
              </Text>
            </View>
          )}
      ...
      <Modal visible={showModal} animationType="slide" presentationStyle="pageSheet">
        <View style={[styles.modal, { backgroundColor: colors.background }]}>
          ...
          <ScrollView contentContainerStyle={{ padding: 20, gap: 8, paddingBottom: 40 }}>
            <Text style={[styles.label, { color: colors.mutedForeground }]}>TÃÂ­tulo *</Text>
            <TextInput
            ...
            <View style={[styles.iaTip, { backgroundColor: "#00d4aa12", borderColor: "#00d4aa33" }]}>
              ...
              <Text style={{ color: "#00d4aa", fontSize: 12, flex: 1, lineHeight: 18 }}>
                A IA verÃÂ¡ todas as tarefas antes de responder. Seja especÃÂ­fico no tÃÂ­tulo para que ela entenda o que jÃÂ¡ foi feito e o que ainda falta.
              </Text>
            </View>
            ...
            >
              ...
              <Text style={{ color: "#000", fontWeight: "700", fontSize: 15 }}>
                {editingTask ? "Salvar alteraÃÂ§ÃÂµes" : "Criar tarefa"}
              </Text>
            </TouchableOpacity>
          </ScrollView>
        </View>
