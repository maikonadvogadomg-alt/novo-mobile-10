...
export function AppProvider({ children }: { children: React.ReactNode }) {
        ...
        files = [
          {
            ...
            name: "README.md",
            path: "README.md",
            content: `# ${repoName}\n\nRepositÃÂ³rio importado de ${provider}.\n\nURL: ${url}\n\n> Arquivos nÃÂ£o puderam ser baixados. Verifique o token e se o repositÃÂ³rio ÃÂ© pÃÂºblico.\n`,
            language: "markdown",
          },
          {
            id: generateId(),
  ...
  const pushToGit = useCallback(
    async (projectId: string, repoUrl: string, token: string, branch = "main"): Promise<{ pushed: number; errors: number }> => {
      ...
      if (!project) throw new Error("Projeto nÃÂ£o encontrado");
      ...
      if (!isGitLab) {
        // GitHub API
        const match = clean.match(/github\.com\/([^/]+)\/([^/]+)/);
        if (!match) throw new Error("URL do GitHub invÃÂ¡lida");
        const [, owner, repo] = match;
        ...
        // GitLab API
        const match = clean.match(/gitlab\.com\/([^?#]+)/);
        if (!match) throw new Error("URL do GitLab invÃÂ¡lida");
        const projectPath = encodeURIComponent(match[1]);
  ...
  // Ã¢ÂÂÃ¢ÂÂ TASKI Ã¢ÂÂ Task management Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
